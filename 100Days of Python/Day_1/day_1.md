...
What is Python?
Python is a dynamically typed general purpose Programming Language that supports object-oriented programming styles as well as a funcional programming styles.
...
It has a big library support. (e.g.: NumPy, TensorFlow, Selenium, OpenCV, etc.)
